...
export default function UserEditScreen(props)
{
    ...
    const { loading: loadingUpdate, error: errorUpdate, succes: successUpdate } = userUpdate;
                    ...
                    (
                        <>
                            ...
                            <div>
                                ...
                                <input id="email" type="email" placeholder="Ingrese Email" value={email} onChange={e => setEmail(e.target.value)}></input>
                            </div>
                            <div>
